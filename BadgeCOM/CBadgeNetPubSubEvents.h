...
public:
    ...
    // Methods
    void Initialize();
    void PublishEventToBadgeCom(EnumEventType eventType, EnumEventSubType eventSubType, EnumCloudAppIconBadgeType badgeType, BSTR *fullPath);
    void SubscribeToBadgeComInitializationEvents();
