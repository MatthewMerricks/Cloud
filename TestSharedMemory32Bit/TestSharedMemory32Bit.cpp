// TestSharedMemory32Bit.cpp : Defines the entry point for the console application.
//
...
int _tmain(int argc, _TCHAR* argv[])
{
   ...
   if(argc == 1){  //Parent process
      ...
      managed_windows_shared_memory segment(create_only, "MySharedMemory", 65536);
      ...
      std::wstring s(argv[0]); 
	  s += L" child ";
      //if(0 != std::system(wcstombs(s..c_str()))
      //   return 1;
      ...
      managed_windows_shared_memory segment(open_only, "MySharedMemory");

      std::pair<MyType*, managed_windows_shared_memory::size_type> res;
