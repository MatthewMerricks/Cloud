...
========================================================================
    ACTIVE TEMPLATE LIBRARY : ContextMenuCOM Project Overview
========================================================================

AppWizard has created this ContextMenuCOM project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

ContextMenuCOM.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

ContextMenuCOM.vcxproj.filters
...
ContextMenuCOM.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ContextMenuCOM.h)
        GUID definitions                                (ContextMenuCOM_i.c)
        A type library                                  (ContextMenuCOM.tlb)
        Marshaling code                                 (ContextMenuCOM_p.c and dlldata.c)

ContextMenuCOM.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ContextMenuCOM.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ContextMenuCOM.pch and a precompiled types file named StdAfx.obj.
...
ContextMenuCOMps.vcxproj
	...
	dlldata.c, ContextMenuCOM_i.c and ContextMenuCOM_p.c which are required
	to build the proxy/stub DLL.

ContextMenuCOMps.vcxproj.filters
