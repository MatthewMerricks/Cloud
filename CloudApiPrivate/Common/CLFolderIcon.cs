...
namespace CloudApiPrivate.Common
{
    public class CLFolderIcon
    {
        ...
        public CLFolderIcon(string folderPath)
        {
                                           ...
                                           string infoTip)
        {
            ...
            // determine whether the icon file exists.  If not, we will reset the icon to the standard folder icon.
            if (!File.Exists(iconFilePath)) 
            {
                CLIniWriter.WriteValue(".ShellClassInfo", "IconFile", String.Empty, this.IniPath);
                CLIniWriter.WriteValue(".ShellClassInfo", "IconIndex", String.Empty, this.IniPath);
                CLIniWriter.WriteValue(".ShellClassInfo", "InfoTip", infoTip ?? String.Empty, this.IniPath);
                return false;
            }
            ...
            CLIniWriter.WriteValue(".ShellClassInfo","IconFile", iconFilePath, this.IniPath);
            CLIniWriter.WriteValue(".ShellClassInfo","IconIndex", iconIndex.ToString(), this.IniPath);
            CLIniWriter.WriteValue(".ShellClassInfo","InfoTip", infoTip ?? String.Empty, this.IniPath);
