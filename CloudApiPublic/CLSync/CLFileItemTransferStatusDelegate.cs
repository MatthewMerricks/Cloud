//
// CLFileItemTransferStatusDelegate.cs
// Cloud Windows
//
...
{
    /// <summary>
    /// Status update callback for upload and download of a file CLFileItem
    /// </summary>
    ...
    public delegate void CLFileItemTransferStatusDelegate(int inputItemIndex, long byteProgress, long totalByteSize, object userState);
}