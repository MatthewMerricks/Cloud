...
namespace Cloud
{
    ...
    public sealed class CLSyncbox
    {
        ...
        /// <param name="name">The friendly name of this syncbox.</param>
        ...
        /// <remarks>Note: The CLSyncbox.Name property must be specified.</remarks>
        ...
        public IAsyncResult BeginUpdateSyncbox(AsyncCallback callback,
            object callbackUserState)
        {
            return _httpRestClient.BeginUpdateSyncbox(callback, callbackUserState, this.Name, _copiedSettings.HttpTimeoutMilliseconds, ReservedForActiveSync);
        }
        ...
        {
            return _httpRestClient.UpdateSyncbox(this.Name, _copiedSettings.HttpTimeoutMilliseconds, out status, out response, ReservedForActiveSync);
        }
