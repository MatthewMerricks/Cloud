            ...
            out CLSyncboxMovePathStatus status)
        {
            ...
            try
            {
                ...
                if (checkBadPath != null)
                {
                    ...
                    throw new ArgumentException("SyncRoot in settingsAtNewPath represents a bad path, check it first via Helpers.CheckForBadPath", checkBadPath.PrimaryException);
                }
                ...
                if (checkPathLength != null)
                {
                    ...
                    throw new ArgumentException("SyncRoot in settings is too long, check it first via Helpers.CheckSyncRootLength", checkPathLength.PrimaryException);
                }
