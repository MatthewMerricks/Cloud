//
// SyncboxDidStopLiveSyncMessage.cs
// Cloud Windows
//
// Created By Bobs.
...
{
    public sealed class SyncboxDidStopLiveSyncMessage : BaseMessage
    {
        ...
        internal SyncboxDidStopLiveSyncMessage(CLSyncbox syncbox, Nullable<long> SyncboxId, string DeviceId)
            : base(EventMessageType.SyncboxDidStopLiveSyncChanged, SyncboxId, DeviceId)
        {
