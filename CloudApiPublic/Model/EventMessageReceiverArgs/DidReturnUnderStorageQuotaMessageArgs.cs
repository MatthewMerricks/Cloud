//
// DidReturnUnderStorageQuotaMessageArgs.cs
// Cloud Windows
//
// Created By BobS.
...
{
    internal sealed class DidReturnUnderStorageQuotaMessageArgs : IDidReturnUnderStorageQuotaMessage
    {
        ...
        #region IDidReturnUnderStorageQuotaMessage members
        #endregion

        internal DidReturnUnderStorageQuotaMessageArgs(EventMessageArgs MessageArgs)
        {
            if (MessageArgs == null)
            {
            ...
            if (MessageArgs.Message.Type != EventMessageType.DidReturnUnderStorageQuotaChanged)
            {
                throw new ArgumentException("MessageArgs Message Type must be DidReturnUnderStorageQuotaChanged, instead it is " + MessageArgs.Message.Type.ToString());
            }
