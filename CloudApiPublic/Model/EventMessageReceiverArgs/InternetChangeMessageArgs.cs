...
{
    internal sealed class InternetChangeMessageArgs : IInternetConnectivityMessage
    {
        ...
        internal InternetChangeMessageArgs(EventMessageArgs MessageArgs)
        {
            if (MessageArgs == null)
            {
