...
{
    internal sealed class IncrementCountMessageArgs : IIncrementCountMessage
    {
        ...
        internal IncrementCountMessageArgs(EventMessageArgs MessageArgs)
        {
            if (MessageArgs == null)
            {
