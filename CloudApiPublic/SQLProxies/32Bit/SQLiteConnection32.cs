...
namespace Cloud.SQLProxies
{
    ...
    /// </remarks>
    internal sealed class SQLiteConnection32 : DisposableProxyObject, ISQLiteConnection
    {
        private readonly SQL32.System.Data.SQLite.SQLiteConnection baseObject;
        ...
        public static ISQLiteConnection Construct(string connectionString)
        {
            try
            {
                return new SQLiteConnection32(new SQL32.System.Data.SQLite.SQLiteConnection(connectionString));
            }
        ...
        private SQLiteConnection32(SQL32.System.Data.SQLite.SQLiteConnection baseObject)
        {
        ...
        {
            base.CheckDisposed();
            SQL32.System.Data.SQLite.SQLiteCommand toWrap;
            try
            {
            ...
            return new SQLiteCommand32(toWrap);
        }
