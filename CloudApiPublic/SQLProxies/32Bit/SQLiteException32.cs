...
namespace Cloud.SQLProxies
{
    ...
    /// </summary>
    internal sealed class SQLiteException32 : SQLiteExceptionBase
    {
        private readonly SQL32.System.Data.SQLite.SQLiteException baseObject;
        ...
        public static SQLiteExceptionBase Construct(WrappedSQLiteErrorCode returnCode, string message)
        {
            try
            {
                SQL32.System.Data.SQLite.SQLiteErrorCode convertCode = (SQL32.System.Data.SQLite.SQLiteErrorCode)((int)returnCode);
                ...
                lock (baseConstructorInfo)
                {
                    ...
                    {
                        baseConstructorInfo.Value = baseExceptionConstructor = typeof(SQL32.System.Data.SQLite.SQLiteException)
                            .GetConstructor(new[] { typeof(SQL32.System.Data.SQLite.SQLiteErrorCode), typeof(string) });
                    }
                    else
                    {
                ...
                SQL32.System.Data.SQLite.SQLiteException baseException = (SQL32.System.Data.SQLite.SQLiteException)baseExceptionConstructor
                        .Invoke(new object[] { convertCode, message });

                return new SQLiteException32(baseException);
            }
        ...
        internal SQLiteException32(SQL32.System.Data.SQLite.SQLiteException baseObject)
        ...
        protected override WrappedSQLiteErrorCode _returnCode
        {
            get
            {
                ...
                lock (baseReturnInfo)
                {
                    ...
                    {
                        Type errorEnumType = typeof(SQL32.System.Data.SQLite.SQLiteErrorCode);
                        baseReturnInfo.Value = returnInfo =
                            typeof(SQL32.System.Data.SQLite.SQLiteException)
                        ...
                        //(PropertyInfo)((MemberExpression)((UnaryExpression)((Expression<Func<SQL32.System.Data.SQLite.SQLiteException, object>>)(member => member.ReturnCode)).Body).Operand).Member;
                    }
                    else
                    {
                ...
                SQL32.System.Data.SQLite.SQLiteErrorCode baseCode = (SQL32.System.Data.SQLite.SQLiteErrorCode)returnInfo.GetValue(baseObject, null);
