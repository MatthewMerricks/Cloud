...
#pragma warning restore 665
        ...
        {
            string logLocation = Helpers.CheckLogFileExistance(traceLocation, UserDeviceId, "Sync", "xml", 
                new Action<TextWriter, string>((logWriter, finalLocation) =>
                    { 
                        logWriter.Write(LogXmlStart(finalLocation, "UDid: {" + UserDeviceId + "}, UUid: {" + UniqueUserId + "}"));
                    }),
