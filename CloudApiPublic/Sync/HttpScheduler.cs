...
namespace CloudApiPublic.Sync
{
    ...
    internal sealed class HttpScheduler : TaskScheduler, IDisposable
    {
        ...
        private const int _fromConcurrencyLevel = CLDefinitions.MaxNumberOfConcurrentDownloads;  // Limit of simultaneous downloads
        private const int _toConcurrencyLevel = CLDefinitions.MaxNumberOfConcurrentUploads;  // Limit of simultaneous uploads
