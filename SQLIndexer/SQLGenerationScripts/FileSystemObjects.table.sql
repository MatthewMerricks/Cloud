...
(
	...
	[TargetPath] nvarchar(max) COLLATE Latin1_General_CS_AS NOT NULL CHECK ([TargetPath] <> ''),
	...
	CONSTRAINT [CHK_FileSystemObjects_TargetPathForFilesOnly] CHECK (([IsFolder] = 1 AND [TargetPath] IS NULL) OR ([IsFolder] = 0 AND [TargetPath] IS NOT NULL))
)