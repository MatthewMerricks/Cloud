...
$(document).ready(function () {
    ...
    function render() {
        ...
        // Bind the page title for one-directional-update, not using data-linking
        $(profile).bind("changeField", function (args, field, value) {
            if (field === "Name") {
        ...
        // Data-linking is now set up, but we need to do an initial "refresh"
        // of the fields so it can kick in and refresh the UI. We're effectively 
        // setting each field value to itself. In the future data-linking will
        // have a way to do this more seamlessly
        ...
        $(profile).bind("changeField", function () {
