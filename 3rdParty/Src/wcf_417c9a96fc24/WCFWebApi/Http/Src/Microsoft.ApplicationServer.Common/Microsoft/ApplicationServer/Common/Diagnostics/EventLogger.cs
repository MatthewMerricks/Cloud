...
namespace Microsoft.ApplicationServer.Common.Diagnostics
{
    ...
    sealed class EventLogger
    {
        ...
        [SuppressMessage(FxCop.Category.Maintainability, FxCop.Rule.AvoidExcessiveComplexity, Justification = "Opened as CSDMain #183075", Scope = "Member", Target = "Microsoft.ApplicationServer.Common.Diagnostics.EventLogger.#UnsafeLogEvent(System.Diagnostics.TraceEventType,System.UInt16,System.UInt32,System.Boolean,System.String[])")]
        ...
        public void LogEvent(TraceEventType type, ushort eventLogCategory, uint eventId, bool shouldTrace, params string[] values)
        {
            ...
            if (canLogEvent)
            {
                ...
                catch (SecurityException ex)
                {
                    ...
                    {
                        TraceCore.HandledException(this.diagnosticTrace, ex);
                    }
                }
            }
             */
        ...
        [SecuritySafeCritical]
        [SecurityPermission(SecurityAction.Demand, UnmanagedCode = true)]
        void SafeSetLogSourceName(string updatedEventLogSourceName)
        {
        ...
        static string UnsafeGetProcessName()
        {
            string retval = null;
            using (Process process = Process.GetCurrentProcess())
            {
        ...
        static string NormalizeEventLogParameter(string eventLogParameter)
        {
