...
using System.Diagnostics.CodeAnalysis;
    ...
    sealed class InputQueue<T> : IDisposable where T : class
    {
        ...
        [SuppressMessage(FxCop.Category.Performance, FxCop.Rule.MarkMembersAsStatic, Justification = "Standard Begin/End Async pattern.", Scope = "Member", Target = "Microsoft.ApplicationServer.Common.InputQueue`1.#DisposeItem(Microsoft.ApplicationServer.Common.InputQueue`1<!0>+Item)")]
        ...
        [SuppressMessage(FxCop.Category.Performance, FxCop.Rule.MarkMembersAsStatic, Justification = "Standard Begin/End Async pattern.", Scope = "Member", Target = "Microsoft.ApplicationServer.Common.InputQueue`1.#EndWaitForItem(System.IAsyncResult)")]
