namespace wyDay.Controls
{
    ...
    {
        internal const string C_PrematureExitTitle = "CloudUpdater exited prematurely";
        internal const string C_PrematureExitMessage = "CloudUpdater ended before the current update step could be completed.";
