...
{
    class YourWindowsService : ServiceBase
    {
        ...
        {
            ServiceName = "YourWindowsService";
        ...
        /// <summary>The Main Thread: This is where your Service is Run.</summary>
        static void Main()
        {
            Run(new YourWindowsService());
        }
        ...
        {
            WriteToLog("=============================", true);
            WriteToLog(".NET Windows Service v1", true);
