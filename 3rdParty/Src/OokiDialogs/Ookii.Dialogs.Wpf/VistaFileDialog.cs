...
namespace Ookii.Dialogs.WpfMinusTaskDialog
{
    ...
    public abstract class VistaFileDialog
    {
        ...
        internal virtual void GetResult(Ookii.Dialogs.WpfMinusTaskDialog.Interop.IFileDialog dialog)
        {
            if( !GetOption(NativeMethods.FOS.FOS_ALLOWMULTISELECT) )
            {
                _fileNames = new string[1];
                Ookii.Dialogs.WpfMinusTaskDialog.Interop.IShellItem result;
        ...
        internal virtual void SetDialogProperties(Ookii.Dialogs.WpfMinusTaskDialog.Interop.IFileDialog dialog)
        {
            uint cookie;
            ...
            {
                Ookii.Dialogs.WpfMinusTaskDialog.Interop.IShellItem item = NativeMethods.CreateItemFromParsingName(_initialDirectory);
        ...
        internal abstract Ookii.Dialogs.WpfMinusTaskDialog.Interop.IFileDialog CreateFileDialog();

        internal bool DoFileOk(Ookii.Dialogs.WpfMinusTaskDialog.Interop.IFileDialog dialog)
        {
            GetResult(dialog);
        ...
        {
            Ookii.Dialogs.WpfMinusTaskDialog.Interop.IFileDialog dialog = null;
            try
            {
