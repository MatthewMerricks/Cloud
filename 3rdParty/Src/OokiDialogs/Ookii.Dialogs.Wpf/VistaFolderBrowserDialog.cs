...
namespace Ookii.Dialogs.WpfMinusTaskDialog
{
    ...
    public sealed class VistaFolderBrowserDialog
    {
        ...
        private bool RunDialog(IntPtr owner)
        {
            ...
            try
            {
                dialog = new Ookii.Dialogs.WpfMinusTaskDialog.Interop.NativeFileOpenDialog();
        ...
        private void SetDialogProperties(Ookii.Dialogs.WpfMinusTaskDialog.Interop.IFileDialog dialog)
        {
            // Description
        ...
        private void GetResult(Ookii.Dialogs.WpfMinusTaskDialog.Interop.IFileDialog dialog)
        {
