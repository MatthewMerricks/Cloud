    ...
    public partial class ProgressDialog : Component
    {
        ...
        public ProgressDialog(IContainer container)
        {
            ...
            if( !NativeMethods.IsWindowsVistaOrLater )
                Animation = AnimationResource.GetShellAnimation(Ookii.Dialogs.WpfMinusTaskDialog.ShellAnimation.FlyingPapers);
        }
        ...
        /// </summary>
        /// <value>
        /// One of the values of <see cref="Ookii.Dialogs.WpfMinusTaskDialog.ProgressBarStyle"/>. 
        /// The default value is <see cref="Ookii.Dialogs.WpfMinusTaskDialog.ProgressBarStyle.ProgressBar"/>.
        /// </value>
        /// <remarks>
        /// <note>
        ...
        ///   progress bar will be hidden completely if this property is <see cref="Ookii.Dialogs.WpfMinusTaskDialog.ProgressBarStyle.MarqueeProgressBar"/>.
        /// </note>
        /// <para>
        ///   When this property is set to <see cref="Ookii.Dialogs.WpfMinusTaskDialog.ProgressBarStyle.ProgressBar" />, use the <see cref="ReportProgress(int)"/> method to set
        ///   the value of the progress bar. When this property is set to <see cref="Ookii.Dialogs.WpfMinusTaskDialog.ProgressBarStyle.MarqueeProgressBar"/>
        ...
        /// </para>
        /// <para>
        ///   This method has no effect is <see cref="ProgressBarStyle"/> is <see cref="Ookii.Dialogs.WpfMinusTaskDialog.ProgressBarStyle.MarqueeProgressBar"/>
        ///   or <see cref="Ookii.Dialogs.WpfMinusTaskDialog.ProgressBarStyle.None"/>.
        /// </para>
        /// </remarks>
        ...
        private void RunProgressDialog(IntPtr owner, object argument)
        {
            ...
            Interop.ProgressDialogFlags flags = Ookii.Dialogs.WpfMinusTaskDialog.Interop.ProgressDialogFlags.Normal;
            if( owner != IntPtr.Zero )
                flags |= Ookii.Dialogs.WpfMinusTaskDialog.Interop.ProgressDialogFlags.Modal;
            switch( ProgressBarStyle )
            {
            case ProgressBarStyle.None:
                flags |= Ookii.Dialogs.WpfMinusTaskDialog.Interop.ProgressDialogFlags.NoProgressBar;
                break;
            case ProgressBarStyle.MarqueeProgressBar:
                if( NativeMethods.IsWindowsVistaOrLater )
                    flags |= Ookii.Dialogs.WpfMinusTaskDialog.Interop.ProgressDialogFlags.MarqueeProgress;
                else
                    flags |= Ookii.Dialogs.WpfMinusTaskDialog.Interop.ProgressDialogFlags.NoProgressBar; // Older than Vista doesn't support marquee.
                break;
            }
            if( ShowTimeRemaining )
                flags |= Ookii.Dialogs.WpfMinusTaskDialog.Interop.ProgressDialogFlags.AutoTime;
            if( !ShowCancelButton )
                flags |= Ookii.Dialogs.WpfMinusTaskDialog.Interop.ProgressDialogFlags.NoCancel;
            if( !MinimizeBox )
                flags |= Ookii.Dialogs.WpfMinusTaskDialog.Interop.ProgressDialogFlags.NoMinimize;
