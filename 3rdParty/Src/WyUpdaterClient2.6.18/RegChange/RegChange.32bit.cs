    ...
    public partial class RegChange
    {
        ...
        static RegistryKey PointerToRegistryKey(IntPtr hKey, bool pWritable)
        {
            ...
            if (SafeRegistryHandleConstructor == null || RegistryKeyConstructor == null)
                throw new Exception("Failed to get the 'SafeHandle' or 'RegistryKey' constructor. Make sure CloudUpdater.exe has full trust Code Access Security (CAS) and make sure you're not using CloudUpdater with the \"supportedRuntime\" configuration.");
