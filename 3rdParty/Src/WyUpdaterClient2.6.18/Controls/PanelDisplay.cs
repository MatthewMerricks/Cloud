...
namespace wyUpdate
{
    ...
    internal class PanelDisplay : ContainerControl
    {
        ...
        {
            SizeF textSize = gr.MeasureString("CloudUpdater", Font);
            midPointY -= (int)(textSize.Height / 2.0);

            //draw the text
            gr.DrawString("CloudUpdater", Font, SystemBrushes.ControlLightLight, new PointF(x, midPointY));
            gr.DrawString("CloudUpdater", Font, SystemBrushes.ControlDark, new PointF(x - 1, midPointY - 1));
