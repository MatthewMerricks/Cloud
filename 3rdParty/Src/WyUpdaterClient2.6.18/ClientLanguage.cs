...
namespace wyUpdate
{
    ...
    public class ClientLanguage
    {
        ...
        string m_AdminError =
            "CloudUpdater needs administrative privileges to update %product%. You can do this one of two ways:\r\n\r\n" +
            "1. When prompted, enter an administrator's username and password.\r\n\r\n" +
            "2. In Windows Explorer right click CloudUpdater.exe and click \"Run as Administrator\"";
        ...
        string m_SelfUpdateInstallError =
            "The updated version of CloudUpdater required to update %product% failed to install.";
        ...
        string m_LogOffError = "Updating %product%. You must cancel CloudUpdater before you can log off.";
        ...
        ScreenDialog m_Checking = new ScreenDialog("Searching for updates",
                                                   "CloudUpdater is searching for updates.",
                                                   "CloudUpdater is searching for updates to %product%. This process could take a few minutes.");
        ...
        ScreenDialog m_DownInstall = new ScreenDialog("Downloading & Installing updates",
                                                      ...
                                                      "CloudUpdater is downloading and installing updates for %product%. This process could take a few minutes.");
        ...
        ScreenDialog m_Uninstall = new ScreenDialog("Uninstalling files, folders, and registry",
                                                    ...
                                                    "CloudUpdater is uninstalling files and registry created when updates were applied to %product%.");
        ...
        string m_DownloadingSelfUpdate = "Downloading new CloudUpdater";
        ...
        string m_SelfUpdate = "Updating CloudUpdater";
        ...
        public string SelfUpdateInstallError =
            "The updated version of CloudUpdater required to update %product% failed to install.";
        public string LogOffError = "Updating %product%. You must cancel CloudUpdater before you can log off.";
        ...
        public string DownloadingSelfUpdate = "Downloading new CloudUpdater";
        public string SelfUpdate = "Updating CloudUpdater";
