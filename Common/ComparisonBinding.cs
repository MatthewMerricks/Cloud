...
namespace win_client.Common
{
    ...
    public class ComparisonBinding : Binding
    {
        ...
        public ComparisonBinding()
            : this(null, ComparisonOperators.EQ, null, null, null) { }

        // Construction with an operator & comparand
        public ComparisonBinding(string path, ComparisonOperators op, object comparand, object nonRelativeSource, RelativeSource relativeSource)
            : base(path)
        {
            if (relativeSource != null)
            {
                if (nonRelativeSource != null)
                {
                    throw new ArgumentException("Cannot set both relative and nonrelative sources");
                }

                RelativeSource = relativeSource;
            }
            else if (nonRelativeSource != null)
            {
                Source = nonRelativeSource;
            }
        ...
        public object NonRelativeSource
        {
            get
            {
                return base.Source;
    ...
    // This IValueConverter is used by the StyleBinding to
